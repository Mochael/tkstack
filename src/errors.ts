...
export class DiffmapCommentError extends errore.createTaggedError({
  name: "DiffmapCommentError",
  message: "diffmap comments failed: $reason",
}) {}

export class DiffmapAgentError extends errore.createTaggedError({
